...
\fbox{
  \vbox{
    \begin{flushleft}
      ...
      EN.605.202.81 \\  %class
      2026-05-25 \\  % date
      Module M - Homework N \\ % ID
    \end{flushleft}
    \center{\Large{\textbf{Topic}}}
    %\end{mdframed}
  } % end vbox
} % end fbox
\vline
...
\noindent\textbf{Problem 4:}  Here is the solution for problem 4. Here is a citation: \textcite[p.204]{sipser2013} ...

Here is another citation. \textcite{zybooks-ds2026}
